...
public class GlideUtil {
     ...
     * @param imageView
     */
    public static void ObjectCircleGlide(Context context, Object o, ImageView imageView){
        RequestOptions options1 = new RequestOptions();
         options1.transform(new GlideCircleTransform());
        Glide.with(context).load(o).apply(options1).into(imageView);
    }
