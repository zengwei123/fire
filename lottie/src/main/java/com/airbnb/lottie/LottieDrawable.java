...
// </editor-fold>
   ...
   * to multiple contents. In that case, the callbacks's value will banner to all of them.
   *
  ...
  public <T> void addValueCallback(
    ...
    if (invalidate) {
      ...
      if (property == LottieProperty.TIME_REMAP) {
        ...
        // to banner, we have to re-set the progress with the current progress so that the
